...
public class Session6AssgnmtCompare2Prices {
	...
	{
		WebElement ele = driver.findElement(By.xpath("//li[@class='ajax_block_product col-xs-12 col-sm-6 col-md-4 last-item-of-tablet-line']"));
	...
	public static void AddToComapare()
	{
		WebElement addToComapre= driver.findElement(By.xpath("//a[@class='add_to_compare' and @data-id-product='5']"));
		addToComapre.click();
	}
	
	public static void AddToComapare1()
	{
		WebElement addToComapre= driver.findElement(By.xpath("//a[@class='add_to_compare' and @data-id-product='6']"));
		addToComapre.click();
	}
	
	public static void ComparePrice() throws InterruptedException
	{
		WebElement compare= driver.findElement(By.xpath("//div[@class='top-pagination-content clearfix']/form/button"));
		compare.click();
		Thread.sleep(1000);
		WebElement price=driver.findElement(By.xpath("//td[@class='ajax_block_product comparison_infos product-block product-5']/div[3]/span[1]"));
		String price1=price.getAttribute("price product-price");
		System.out.println("Price of first : "+ price1);
	}
