...
public class VijayDemo {
	...
	private static void elementActions() throws InterruptedException {
		...
		*/
		String languages = "JAVA # Python #c #Csharph #vbscript";
		...
		for (String l : language) {
			...
			if(l.trim().equalsIgnoreCase("java")) {
				...
				WebElement python = driver.findElement(By.xpath("//input[contains(@value,'python')]"));
				python.click();
